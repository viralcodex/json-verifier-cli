const constants = {
    ...
    consoleConstants: {
        packageDescription: `JSON VERIFIER CLI\nCheck whether the JSON files are valid or not and parse one or all of them together.\nJust open the terminal in the directory your files/folders are present and use one of the following commands.`,
        loggingFlagsN: ["N", "n"],
        loggingFlagsY: ["Y", "y"],
        lineBreak: "---------------------------------",
        logMessageN: "Logging was disabled for this verification, please re-run it without any flag to log the results",
        logMessageY: 'Please find the detailed log file created in LOGS folder:',
        validJson: "Valid Json file",
        invalidJson: "Invalid JSON file: ",
        totalValidJsons: "Valid JSONs: ",
        totalInvalidJsons: "Invalid JSONs: ",
        totalFilesVerified: "Total files verified: ",
        yes: "Y",
        no: "N",
        options: {
            file: {
                command: "-f, --file <file_path>",
                description: "provide the file path for the JSON file to be checked"
            },
            folder: {
                command: "-fd, --folder <folder_path>",
                description: "provide the folder path with JSON files to be checked"
            },
            maxDepth: {
                command: "-md, --max-depth <number>",
                description: "Set your max-depth for the JSON file(s) you want to check. Default value is 19"
            },
            logging: {
                command: "-l --logging <Y/N>",
                description: "Choose if you want to disable logging the results of this verification or not. Logging is enabled by default"
            }
        }
    },
    parsingConstants: {
